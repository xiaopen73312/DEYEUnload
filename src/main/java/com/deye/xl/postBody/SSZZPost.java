...
import com.deye.xl.httpService.ZZJSClinet;
 ...
 */
@Component
public class SSZZPost {

    private static final Logger log = LoggerFactory.getLogger(SSZZPost.class);
    @Autowired
    ZZJSClinet deyeClinet;
    @Autowired
    Gson gson;
    @Value("${deye.appid}")
